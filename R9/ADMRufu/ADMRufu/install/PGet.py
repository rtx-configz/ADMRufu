...
def print_usage():
    print '\nUsage  : python PGet.py -b listening -p pass'
    print 'Example: python PGet.py -b 0.0.0.0:80 -p pass123'
    print '       : python PGet.py -b 0.0.0.0:80 -p passFile.pwd\n'
    print '___Password file example:___'
    print PasswordSet.FILE_EXAMPLE
